...
public class ParkingLotSystemTest {
    ...
    public void givenAVehicle_WhenParked_ShouldReturnTrue() {
        try {
            vehicle = new Vehicle("1", Vehicle.VehicleType.NORMAL);
    ...
    public void givenAVehicle_WhenAllReadyParked_ShouldThrowException() {
        ...
        try {
            parkingLotSystem.park(new Vehicle("1", Vehicle.VehicleType.NORMAL));
            parkingLotSystem.park(new Vehicle("2", Vehicle.VehicleType.NORMAL));
            parkingLotSystem.park(new Vehicle("3", Vehicle.VehicleType.NORMAL));
        } catch (ParkingLotSystemException e) {
    ...
    public void givenAVehicle_WhenUnParked_ShouldReturnTrue() {
        try {
            Vehicle vehicle1 = new Vehicle("1", Vehicle.VehicleType.NORMAL);
    ...
    public void givenAVehicle_WhenNoVehicleUnParked_ShouldThrowException() {
        try {
            Vehicle vehicle1 = new Vehicle("1", Vehicle.VehicleType.NORMAL);
            Vehicle vehicle2 = new Vehicle("2", Vehicle.VehicleType.NORMAL);
            parkingLotSystem.park(vehicle1);
    ...
    public void givenAVehicle_WhenThereIsSpace_ShouldAllowToPark() {
        Vehicle vehicle1 = new Vehicle("1", Vehicle.VehicleType.NORMAL);
        Vehicle vehicle2 = new Vehicle("2", Vehicle.VehicleType.NORMAL);
        Vehicle vehicle3 = new Vehicle("3", Vehicle.VehicleType.NORMAL);
        try {
            parkingLotSystem.park(vehicle1);
    ...
    public void givenAVehicle_WhenDriverIsHandicap_ShouldParkedVehicleAtNearestPosition() {
        Vehicle vehicle1 = new Vehicle("1", Vehicle.VehicleType.NORMAL);
        Vehicle vehicle2 = new Vehicle("2", Vehicle.VehicleType.NORMAL);
        Vehicle vehicle3 = new Vehicle("2", Vehicle.VehicleType.HANDICAP);
        try {
            parkingLotSystem.park(vehicle1);
            parkingLotSystem.park(vehicle2);
            parkingLotSystem.unPark(vehicle1);
